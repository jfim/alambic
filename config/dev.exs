...
config :alambic, AlambicWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "Bu+XhhZlXQIXxyEaSRC2ohl2ArbZP+mBA/SEuRtsUpKr80Gmm4GZpnbrHyKw30og",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:alambic, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:alambic, ~w(--watch)]}
  ]
...
config :alambic, AlambicWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/alambic_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :alambic, dev_routes: true
